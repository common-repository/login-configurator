...
/*
  ...
  Plugin URI: https://grandslambert.com/plugins/login-configurator
  ...
  Author URI: https://www.grandslambert.com/

 * *************************************************************************

  Copyright (C) 2009-2022 GrandSlambert
...
class gsLoginConfigurator {
	...
	function contributor_list() {
		...
		if ( function_exists( 'simplexml_load_file' ) ) {
			...
			$items = simplexml_load_file( 'https://cdn.grandslambert.com/xml/login-configurator.xml' );
