     ...
     <div class="table">
          <table class="form-table">
			...
			<tr align="top">
				...
				<td><label>
						<input type="radio" id="login_configurator_feed_no" name="<?php print $this->optionsName; ?>[feed]" value="1" <?php checked( $this->options['feed'], 1 ); ?> />
						<?php _e( '<strong>Protected</strong> - Protect the feed URL as well.', 'login-configurator' ); ?>
                         </label>
                         <br />
                         <label>
                              <input type="radio" id="login_configurator_feed_yes" name="<?php print $this->optionsName; ?>[feed]" value="0" <?php checked( $this->options['feed'], 0 ); ?> />
